...
```{r UEtimespentplaying, echo=FALSE, fig.height=4, fig.width=4, fig.cap="Relationship between participants' recall scores and the time they spent playing the game. Solid black line and shaded area represent fit and the 95% confidence interval of the linear model, respectively."}
